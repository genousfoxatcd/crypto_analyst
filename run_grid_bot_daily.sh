...
# Step 1: 价格归档
echo "  [1/4] 归档当前价格..."
$PYTHON grid_bot_sim.py --cmd archive 2>&1 | tail -3

# Step 2: 更新机器人状态
echo "  [2/4] 更新机器人状态..."
$PYTHON grid_bot_sim.py --cmd update 2>&1 | tail -5

# Step 3: 状态快照
echo "  [3/4] 状态快照..."
$PYTHON grid_bot_sim.py --cmd status 2>&1 | tail -8

# Step 4: 生成日报
echo "  [4/4] 生成日报..."
$PYTHON grid_bot_sim.py --cmd report 2>&1 | tail -3
